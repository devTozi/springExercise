            ...
            <div class="swiper-container">
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <a href=" ${pageContext.request.contextPath}/resources/css/swiper.min.css"><img src=" ${pageContext.request.contextPath}/resources/img/mainslide_mob01.jpg" alt="TRUST & INFORMATION 믿을 수 있는 여행정보, 여행... 어디로 가세요?" /></a>
                    </div>
                    <div class="swiper-slide">
                        <a href=" ${pageContext.request.contextPath}/resources/css/swiper.min.css"><img src=" ${pageContext.request.contextPath}/resources/img/mainslide_mob02.jpg" alt="TRUST & INFORMATION 믿을 수 있는 여행정보, 여행... 어디로 가세요?" /></a>
                    </div>
                    <div class="swiper-slide">
                        <a href=" ${pageContext.request.contextPath}/resources/css/swiper.min.css"><img src=" ${pageContext.request.contextPath}/resources/img/mainslide_mob03.jpg" alt="TRUST & INFORMATION 믿을 수 있는 여행정보, 여행... 어디로 가세요?" /></a>
                    </div>
                </div>						
